...
void getSQ(int i, out float params[11])
{
    if (i == 0) {
        const float tmp[11] = float[11](
            7.7660e-02, 1.0287e+00, 1.2761e-01,
            1.2761e-01, 6.3520e-01, -3.1416e+00,
            -7.8539e-01, 1.5708e+00, -9.9608e-01,
            -1.7268e-01, 3.9216e-03
        );
        for (int k = 0; k < 11; ++k) params[k] = tmp[k];
    }
    else if (i == 2) {
        const float tmp[11] = float[11](
            1.7447e+00, 9.9789e-01, 1.2561e-01,
            1.2561e-01, 4.5215e-01, -3.4638e-05,
            -9.2336e-01, -1.5708e+00, -9.9609e-01,
            4.2680e-01, 3.9243e-03
        );
        for (int k = 0; k < 11; ++k) params[k] = tmp[k];
    }
    else {
