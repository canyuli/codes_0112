...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    primitive_dist=sdArc(uv,-0.001,-0.052,1.115,3.141,0.459,0.065);
    d=opUnion(d, primitive_dist);
    primitive_dist=sdArc(uv,0.301,0.183,1.554,0.000,0.160,0.064);
    d=opUnion(d, primitive_dist);
    primitive_dist=sdArc(uv,-0.301,0.182,1.546,6.282,0.160,0.064);
    d=opUnion(d, primitive_dist);
    // 3. 抗锯齿上色（基于最终 d）
