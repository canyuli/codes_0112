...
void mainImage( out vec4 fragColor, in vec2 fragCoord )
{
    ...
    primitive_dist=sdCapsule(uv,0.668,-0.065,0.099,4.722,0.234);
    d=opUnion(d, primitive_dist);
    primitive_dist=sdCapsule(uv,-0.669,-0.064,0.099,4.699,0.234);
    d=opUnion(d, primitive_dist);
    primitive_dist=sdCircle(uv, 0.179,-0.741,0.178);
    d=opUnion(d, primitive_dist);
    primitive_dist=sdCapsule(uv,0.669,-0.062,0.104,4.712,0.103);
    d=opSubtraction(d, primitive_dist);
    primitive_dist=sdCapsule(uv,-0.669,-0.062,0.104,4.713,0.103);
    d=opSubtraction(d, primitive_dist);
